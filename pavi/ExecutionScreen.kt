...
class ExecutionScreen: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        executeButton.setOnClickListener {
            ...
            val selectedTestProfile = spinnerTestProfile.selectedItem.toString()
            val selectedUEProfile = spinnerUEProfile.selectedItem.toString()

            // Check if a valid job is selected
            ...
            // Check if a valid Test Profile is selected
            if (selectedTestProfile == "Select an option") {
                Toast.makeText(this, "Please select a valid Test Profile", Toast.LENGTH_SHORT).show()
                return@setOnClickListener
            }

            // Check if a valid UE Profile is selected
            if (selectedUEProfile == "Select an option") {
                Toast.makeText(this, "Please select a valid UE Profile", Toast.LENGTH_SHORT).show()
                return@setOnClickListener
            }

            // Check if at least one Test Suite is selected
            if (selectedTestSuitesNames.isEmpty()) {
                Toast.makeText(this, "Please select at least one Test Suite", Toast.LENGTH_SHORT).show()
                return@setOnClickListener
            }

            // Check if at least one Test Case is selected
            if (selectedTestCasesNames.isEmpty()) {
                Toast.makeText(this, "Please select at least one Test Case", Toast.LENGTH_SHORT).show()
                return@setOnClickListener
            }

            // Check if at least one App Server is selected
            if (selectedAppServerNames.isEmpty()) {
                Toast.makeText(this, "Please select at least one App Server", Toast.LENGTH_SHORT).show()
                return@setOnClickListener
            }

            // Check if at least one Use Case is selected
            if (selectedUseCasesNames.isEmpty()) {
                Toast.makeText(this, "Please select at least one Use Case", Toast.LENGTH_SHORT).show()
                return@setOnClickListener
            }
//            val selectedJob = spinner.selectedItem.toString()
//
...
//            }
            ...
            // If all validations pass, proceed with the job execution
